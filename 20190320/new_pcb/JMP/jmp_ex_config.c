...
void jmp_ex_config_default_set(void)
{
	...
	jmp_ex_config_struct.y_max_feedrate=X_MAX_FEEDRATE;
	jmp_ex_config_struct.z_max_feedrate=X_MAX_FEEDRATE;
	jmp_ex_config_struct.e_max_feedrate=X_MAX_FEEDRATE;
