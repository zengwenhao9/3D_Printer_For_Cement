...
void MPU_Memory_Protection(void)
{
	...
	//MPU_Set_Protection(0x24000000,MPU_REGION_SIZE_512KB,MPU_REGION_NUMBER1,MPU_REGION_FULL_ACCESS);	//保护整个D1 SRAM 512KB
	MPU_Set_SRAMProtection(0x24000000,MPU_REGION_SIZE_512KB,MPU_REGION_NUMBER1,MPU_REGION_FULL_ACCESS);	//保护整个D1 SRAM 512KB
