...
void jmp_motion_state_get(void)
{
	...
	float speed;
	#ifdef COREXY
	x=((double)current_block->steps_x)/axis_steps_per_unit[X_AXIS]+((double)current_block->steps_y)/axis_steps_per_unit[Y_AXIS];
	y=((double)current_block->steps_x)/axis_steps_per_unit[X_AXIS]-((double)current_block->steps_y)/axis_steps_per_unit[Y_AXIS];
	#else
...
//		plan_set_position(0,0,0,0);
//		
//		plan_buffer_line(100,100,0,0,5,active_extruder);
//		while(blocks_queued())
//		{
//			vTaskDelay(10);
//		}
//		vTaskDelay(1000);
//		plan_buffer_line(0,0,0,0,5,active_extruder);
//		while(blocks_queued())
//		{
//			vTaskDelay(10);
//		}
...
//		}
//		vTaskDelay(1000);
//		plan_buffer_line(100,100,0,0,50,active_extruder);
//		plan_buffer_line(0,0,0,0,50,active_extruder);
//		plan_buffer_line(100,100,0,0,25,active_extruder);
//		plan_buffer_line(0,0,0,0,25,active_extruder);
//		plan_buffer_line(100,100,0,0,25,active_extruder);
//		plan_buffer_line(0,0,0,0,25,active_extruder);
//		plan_buffer_line(100,100,0,0,25,active_extruder);
